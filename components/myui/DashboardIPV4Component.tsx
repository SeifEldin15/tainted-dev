            ...
            <div className="mt-4 flex flex-col-reverse justify-between gap-5 sm:flex-row sm:items-end">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-row items-center gap-2.5">
                  ...
                  <div className="text-white/80">Unlimited Bandwidth</div>
                </div>
                <div className="flex flex-row items-center gap-2.5">
                  <div className="h-2.5 w-2.5 rounded-full bg-brand"></div>
                  <div className="text-white/80">Authenticated & IP Auth Options</div>
                </div>
                <div className="flex flex-row items-center gap-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-brand"></div>
                  <div className="text-white/80">Large IP Pool</div>
                </div>
                <div className="flex flex-row items-center gap-2.5">
                  <div className="h-2.5 w-2.5 rounded-full bg-brand"></div>
                ...
                <div className="flex flex-row items-center gap-2.5">
                  <div className="h-2.5 w-2.5 rounded-full bg-brand"></div>
                  <div className="text-white/80">Sticky Sessions Supported</div>
                </div>
                <div className="flex flex-row items-center gap-2.5">
                  <div className="h-2.5 w-2.5 rounded-full bg-brand"></div>
                  <div className="text-white/80">Works On All Websites</div>
                </div>
                <div className="flex flex-row items-center gap-2.5">
                  <div className="h-2.5 w-2.5 rounded-full bg-brand"></div>
                  <div className="text-white/80">Custom Length & Thread Count Supported</div>
                </div>
              </div>
              <div className="flex flex-col sm:items-end">
                ...
                <div className="relative py-4 space-y-2">
                  <div className="flex flex-col gap-2">
                    <div className="text-white/90">{`Thread Count:`}</div>

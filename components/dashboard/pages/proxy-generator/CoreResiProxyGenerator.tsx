  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 mt-6 w-full">
        {/* Generator Settings */}
        <div className="bg-white dark:bg-gray-800 rounded-lg py-4 px-5 flex flex-col gap-2 lg:max-w-[400px] w-full border-transparent dark:border-transparent shadow-sm hover:shadow-md transition-all duration-300">
          <div className="text-gray-900 dark:text-white">Generator Settings</div>
                ...
                <div className="mt-4 flex flex-col gap-6">
                  ...
                  {values?.isRotating == false && (
                    <div className="grid gap-2">
                      ...
                      <Input
                        className="border-gray-300 dark:border-transparent disabled:opacity-80 focus:ring-brand focus:border-brand dark:bg-gray-700 dark:text-white"
                  ...
                  <div className="flex flex-row gap-4">
                    <Button
                      className="w-full bg-brand !text-black hover:bg-brand/90 transition-all duration-300"
          ...
          {/* Whitelist IPs */}
          <div className="my-2">
            <div className="text-[16px] mb-2 text-gray-900 dark:text-white">Whitelist IPs</div>
            <div className="h-[1px] bg-gray-300 dark:bg-gray-700 mb-4"></div>
        ...
        {/* Generated Proxies */}
        <div className="bg-white dark:bg-gray-800 rounded-lg py-4 px-5 flex flex-col gap-2 w-full border-transparent dark:border-transparent shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <div className="mt-4 flex flex-col gap-6 h-full">
            ...
            <div className="flex flex-col gap-2 h-full">
              ...
              <Textarea
                  className="border-gray-300 dark:border-transparent disabled:opacity-100 lg:h-full min-h-[200px] lg:min-h-fit flex-1 disabled:cursor-text dark:bg-gray-700 dark:text-white"

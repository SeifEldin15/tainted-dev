    ...
    <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16 items-center">
        <div className="max-w-md">
          <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Integrity</h3>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16 items-center">
        <div className="md:order-2 max-w-md md:ml-auto">
          <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Privacy</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div className="max-w-md">
          <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Cat Care Support</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">

  ...
  "inline-flex items-center justify-center disabled:cursor-not-allowed whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        // brand Color button
        brand:
          "bg-brand text-brand-foreground shadow-sm hover:bg-brand/90 text-black",
        // Attention Red Color button
        attention:
          "bg-red-500 text-destructive-foreground shadow-sm hover:bg-red-500/80",
        // Warrning Red Color button
        warning:
          "bg-yellow-500 text-destructive-foreground shadow-sm hover:bg-yellow-500/80",
      },
      size: {
